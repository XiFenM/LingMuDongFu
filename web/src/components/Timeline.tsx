...
function YearRingField({ items }: { items: TimelineItem[] }) {
  return (
    <div className="pointer-events-none absolute left-[calc(-64vw-470px)] top-[-320px] -z-10 h-[980px] w-[1650px] max-w-none md:left-[-760px] md:top-[-310px] md:h-[1040px] md:w-[1750px] lg:left-[-940px] lg:top-[-370px] lg:h-[1160px] lg:w-[2100px]">
      <div
        aria-hidden
